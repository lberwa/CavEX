...
void gfx_setup() {
	...
	render_text("tex_init wird aufgerufen", 10, 10, "blue");
	tex_init();
	render_text("tex_init ist zu ende", 20, 20, "blue");
	...
	GX_DrawDone();
        ...
        render_text("gfx_setup wurde bis zum", 10, 50, "blue");
        render_text(" ende durchgeführt", 10, 60, "blue");
	for (int i = 0; i < 300; i++) {
        	VIDEO_WaitVSync();
    	}
