...
#define WINDOWC_SIGN 5
#define WINDOWC_BREWING_STAND 6
#define WINDOWC_ENCHANTING_TABLE 7
...
enum window_type {
	...
	WINDOW_TYPE_SIGN = 5,
	WINDOW_TYPE_BREWING_STAND = 6,
	WINDOW_TYPE_ENCHANTING_TABLE = 7,
	WINDOW_TYPE_ENDER_CHEST = 8,
