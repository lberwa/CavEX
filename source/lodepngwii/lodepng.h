...
unsigned lodepng_decode32_file(unsigned char** out, unsigned* w, unsigned* h,
                               const char* filename);
/*                           
unsigned lodepng_decode32_file_c(unsigned char** out, unsigned* w, unsigned* h,
                               const char* filename);
*/
...
unsigned lodepng_decode32_file_c(unsigned char** out, unsigned* w, unsigned* h, const char* filename);
